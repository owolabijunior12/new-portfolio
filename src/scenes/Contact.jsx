      ...
      <div className="md:flex md:justify-between gap-16 mt-5">
        ...
        >
          ...
          >
            ...
            <textarea
              className="w-full bg-blue font-semibold text-black placeholder-opaque-black p-3 mt-5"
              name="message"
              placeholder="MESSAGE"
              rows="4"
              cols="50"
            ...
            <button
              className="p-5 bg-green-400 font-semibold text-deep-blue mt-5 hover:bg-red hover:text-white transition duration-500"
              type="submit"
            >
              SEND ME A MESSAGE
            </button>
